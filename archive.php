...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		...
		echo do_shortcode('[ajax_load_more loading_style="infinite fading-circles" post_type="' . $cpt . '" pause="true" scroll_distance="-200" progress_bar="true" progress_bar_color="cd2c00" button_label="More" no_results_text="&lt;p&gt;There’s no content to show at the moment.&lt;/p&gt;"]');
